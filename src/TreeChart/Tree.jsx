...
import debugData from "./data.json"

const RightContainer = React.lazy(() => import("./RightContainer"));

export default function Treee() {

  // State Management For Fetch Data
  const [axiosFetchData, setAxiosFetchData] = useState({});
  ...
  const click = (data) => {
    ...
    setPopulation(dataNode.veri.verisi)
  };
  ...
  const [jsonData, setJsonData] = useState(debugData);
  ...
  return (
    <div>
      ...
      <div>
        <RightContainer data={dataName} ppltn={population}/>
      </div>
